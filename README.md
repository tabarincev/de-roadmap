...
- [Data Lakes]()
  - [Data Lake](https://github.com/tabarincev/de-roadmap/blob/main/concepts/storage_design/DataLakes.md#data-lake)
  - [Data Lakehouse](https://github.com/tabarincev/de-roadmap/blob/main/concepts/storage_design/DataLakes.md#data-lakehouse)
...
- [Основные концепции и архитектура]()
  - [Архитектура](https://github.com/tabarincev/de-roadmap/blob/main/technologies/spark/Architecture.md)
    ...
    - [Архитектура Spark-кластера](https://github.com/tabarincev/de-roadmap/blob/main/technologies/spark/Architecture.md#архитектура-spark-кластера)
      - [Как Spark планирует и запускает задачи ?]()
...
- [Архитектура]() 
  - [Компоненты]() 
    - [Необходимые]()
    - [Дополнительные]() 
- [Термины](https://github.com/tabarincev/de-roadmap/blob/main/technologies/airflow/architecture.md#основные-термины) 
	- [DAG](https://github.com/tabarincev/de-roadmap/blob/main/technologies/airflow/dag.md)
	- [DagRun](https://github.com/tabarincev/de-roadmap/blob/main/technologies/airflow/dag_run.md)
